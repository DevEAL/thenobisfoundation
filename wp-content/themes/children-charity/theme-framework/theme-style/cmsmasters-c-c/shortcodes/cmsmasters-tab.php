...
if ($custom_colors == 'true') { 
	...
	$this->tabs_atts['style_tab'] .= "\n" . '#cmsmasters_tabs_list_item_' . esc_attr($unique_id) . ':before,' . 
	'#cmsmasters_tabs_list_item_' . esc_attr($unique_id) . ':after,' . 
	'#cmsmasters_tabs_list_item_' . esc_attr($unique_id) . '.current_tab:before,' . 
	'#cmsmasters_tabs_list_item_' . esc_attr($unique_id) . '.current_tab:after { ' . 
